      ...
      >
        <div class={styles.primaryAmount}>
          ...
          <div class={styles.amount}>
            {formatAmount((primary()?.amount || 0).toFixed(floatingPoints[primary()?.currency?.shorthand || '_']), 5)}
          </div>
        ...
        <div class={styles.secondaryAmount}>
          ...
          <div class={styles.amount}>
            {formatAmount((secondary()?.amount || 0).toFixed(floatingPoints[secondary()?.currency?.shorthand || '_']), 5)}
          </div>
          <div class={styles.amountPostfix}>
